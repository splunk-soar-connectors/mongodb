...
This table lists the configuration variables required to operate MongoDB. These variables are specified when configuring a MongoDB asset in Splunk SOAR.
